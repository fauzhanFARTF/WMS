...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;"> &nbsp; <a href="../config/loguot.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>
        <!-- /. NAV TOP  -->
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>User dan Item<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="?halaman=manajemen_user"><i class="fa fa-user fa-3x"></i> Users</a>
                            </li>
                            <li>
                                <a href="?halaman=manajemen_item"><i class="fa fa-external-link fa-3x"></i> Item</a>
                            </li>
                            <li>
                                <a href="?halaman=manajemen_lokasi"><i class="fa fa-external-link fa-3x"></i> Rack</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="?halaman=manajemen_pesanan"><i class="fa fa-external-link fa-3x"></i>Barang Order</a>
                            </li>
                            <li>
                                <a href="?halaman=manajemen_pesanan"><i class="fa fa-external-link fa-3x"></i>Barang Masuk</a>
                            </li>
                            <li>
                                <a href="?halaman=manajemen_pesananbatal"><i class="fa fa-external-link fa-3x"></i>Barang Keluar</a>
                            </li>
                        </ul>
                    </li>
