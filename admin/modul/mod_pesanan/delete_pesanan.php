...
<?php
    ...
    $quw = mysqli_query($conn, "SELECT * FROM td_pesanan INNER JOIN tm_unit ON td_pesanan.id_unit = tm_unit.id_unit WHERE kd_transaksi=$kd_transaksi");
    ...
    if ($kol == 1) {
        ...
        if ($kapasitas >= 50) {
            ...
            $tamm = mysqli_query($conn, "UPDATE tm_unit SET kapasitas='$kapasitas' WHERE id_unit='$kol'");
        }
    } else {
        ...
        if ($kapasitas1 >= 50) {
            ...
            $tamm1 = mysqli_query($conn, "UPDATE tm_unit SET kapasitas='$kapasitas1' WHERE id_unit='$kol'");
        }
    }
