    ...
    $qua = mysqli_query($conn, "SELECT td_konfirmasi.*, td_pesanan.*, tm_unit.* FROM td_konfirmasi JOIN td_pesanan on td_konfirmasi.kd_transaksi = td_pesanan.kd_transaksi JOIN tm_unit on td_pesanan.id_unit = tm_unit.id_unit WHERE id_konfirm='$id_konfirm'");
