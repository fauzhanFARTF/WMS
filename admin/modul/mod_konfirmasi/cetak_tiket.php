...
$query = mysqli_query($conn, "SELECT * FROM td_pesanan JOIN td_konfirmasi ON td_konfirmasi.kd_transaksi = td_pesanan.kd_transaksi JOIN tm_user ON td_pesanan.nik = tm_user.nik JOIN tm_unit ON td_pesanan.id_unit = tm_unit.id_unit WHERE td_konfirmasi.id_konfirm = '$id_konfirm'") or die(mysqli_error($conn));
...
<div class='container-fluid'>
    ...
    <div class='row-fluid'>
        <div class='col-md-8'>
            ...
            <table class=''>
                <h4 style="padding-top: 1px;">KONTRAKAN PERSADA</h4>
                <tbody>
                    <tr>
                        <td>
    ...
    <div class='row-fluid'>
        <div class='span12'>
            <table class='table table-bordered table-invoice-full'>
                ...
                <tbody>
                    <?php
                    $SQL = mysqli_query($conn, "SELECT * FROM tm_unit  WHERE id_unit = '$id_kol'");
                ...
                <tbody>
                    <tr>
                        <td class='msg-invoice' width='85%'>
                            <h4>INVOICE PEMESANAN KONTRAKAN PERSADA </h4>
