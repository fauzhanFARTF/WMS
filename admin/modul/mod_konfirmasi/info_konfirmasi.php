...
$query = mysqli_query($conn, "SELECT * FROM td_pesanan JOIN td_konfirmasi ON td_konfirmasi.kd_transaksi = td_pesanan.kd_transaksi JOIN tm_user ON td_pesanan.nik = tm_user.nik JOIN tm_unit ON td_pesanan.id_unit = tm_unit.id_unit WHERE td_konfirmasi.sts='Bukti Pembayaran Masuk' OR td_konfirmasi.sts = 'Bukti Pembayaran Diterima' order by td_pesanan.status asc") or die(mysqli_error($conn));
?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form enctype="multipart/form-data" action="..\admin\modul\mod_konfirmasi\add_konfirmasi.php" class="form-horizontal" method="POST">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4">Kontrakan Tipe :</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="unit" id="qolam" readonly required>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="margin-top:100px;">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="text-align:center;">Anda akan merelease unit kontrakan kembali ?</h4>
            </div>
